...
def init(request):
    try:
        ...
        sql = """CREATE TABLE IF NOT EXISTS ex02_movies (
    ...
    try:
        conn = psycopg2.connect(
            "dbname={} user={} password={} host={} port={}".format(
                ...
                settings.DATABASES['default']['PORT']))
        with conn.cursor() as curs:
            curs.execute("""select episode_nb, title, opening_crawl, director, producer, release_date from ex02_movies""")
